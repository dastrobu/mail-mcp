...
type ReplaceOutgoingMessageInput struct {
	...
	Content       string    `json:"content" jsonschema:"New email body content. Supports Markdown formatting. Always include a space before and after inline code (backtick) spans, e.g. use 'the \`foo\` bar' not 'the \`foo\`bar'." long:"content" description:"New email body content. Supports Markdown formatting."`
