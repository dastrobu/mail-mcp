...
type ReplaceReplyInput struct {
	...
	Content       string  `json:"content" jsonschema:"New email body content for the reply. Supports Markdown formatting. Always include a space before and after inline code (backtick) spans, e.g. use 'the foo bar' not 'the foobar' (with backticks around foo)." long:"content" description:"New email body content for the reply. Supports Markdown formatting."`
