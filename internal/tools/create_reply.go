...
type CreateReplyInput struct {
	...
	Content       string   `json:"content" jsonschema:"Email body content for the reply. Supports Markdown formatting. Always include a space before and after inline code (backtick) spans, e.g. use 'the foo bar' not 'the foobar' (with backticks around foo)." long:"content" description:"Email body content for the reply. Supports Markdown formatting."`
